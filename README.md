...
pull-up, без runtime-регулировки и PWM. Зелёный — NOTE-layer, cyan —
CC-layer, жёлтый — SHIFT, magenta — SETUP, синий — ROOT/HARMONY, красный —
nRF не найден. MIDI event даёт тусклую короткую белую вспышку и возвращает
цвет режима.
